        ...
        <div className={style.content}>
          ...
          <div className="columns">
            <div className="column">
              ...
              <progress class="progress is-success is-small" value="0" max="100"></progress>
              <div className={style.flex}>
                <div>Peso inicial<br /><div></div></div>
                <div>Peso moega<br /><div></div></div>
                <div>Peso final<br /><div></div></div>
              ...
              <progress class="progress is-success is-small" value="25" max="100"></progress>
              ...
              <progress class="progress is-success is-small" value="75" max="100"></progress>
              ...
              <progress class="progress is-success is-small" value="100" max="100"></progress>
